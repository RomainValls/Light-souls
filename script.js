...
function move2(direction) {
	...
	if (allTheCells[playerPosition].classList.contains("targetThree")) {   //je veux que les pnj soient des objets colision. 
            ...
            dialogTextThree.textContent = "This is your first challenge adventurer ! bakrnfanfnazefnazjnfvlaernvlanevn,arnvazrjnlvanerj";
...
function move3(direction) {
	...
	if (allTheCells[playerPosition].classList.contains("targetFive")) {   //je veux que les pnj soient des objets colision. 
        
            console.log("coucoucoucouchoerfve")

            function createDialog() {
            const dialogDivFive = document.createElement("div");
            dialogDivFive.id = "dialog5";
            const dialogTextFive = document.createElement("p");
            dialogTextFive.textContent = "This is your fifth challenge adventurer ! bakrnfanfnazefnazjnfvlaernvlanevn,arnvazrjnlvanerj";
	...
	if (allTheCells[playerPosition].classList.contains("targetSix")) {    
        ...
        function createDialog() {
            ...
            const button11 = document.createElement("button7");
            ...
            dialogDivSix.appendChild(button7);
            dialogDivSix.appendChild(button8);
        ...
        if (!allTheCells.some(cell => cell.classList.contains("targetFive") || cell.classList.contains("targetSix"))) {
            // both targets have been removed, display exit
            displayExit3();
	        }
        } 
